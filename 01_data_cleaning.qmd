...
**2023-11-08**, revised drop criteria
...
We also examined for subjects that were missing our exposure of interest (family income ratio). This resuletd in a further 323 excluded subjects.
...
combined_data <- combined_data |>
  relocate(
    ...
    # Demographics, SES
    age, sex, race_5cat, race_6cat, marital_status,
    educ_level, occupation_type_week,
    accult_birth_country, accult_time_usa,
    # Exposure of Interest: Income
    income_ratio, income_cat,
    # Insurance
    ins_dichot_original, ins_classif, ins_type, ins_any_gap,
